...
import { triFont, interFont } from '@/app/fonts';
import { Button } from '@/components/ui/button';
import { Expand } from 'lucide-react';
import { CaseStudyDialog } from '@/app/components/casestudy_dialog';
  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto flex flex-col">
      ...
      <div className="content-stretch flex gap-[24px] items-start justify-start relative shrink-0 w-full">
            ...
            <motion.div 
              className="content-stretch flex flex-col gap-[16px] items-start justify-start leading-none relative shrink-0 text-black w-full max-w-[600px]"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
