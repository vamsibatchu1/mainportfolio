...
export const Component = () => {
  ...
  return (
    <div 
      className="flex w-52 flex-col items-start gap-y-1 rounded-lg border border-gray-300 bg-[#f6f6f6] p-1" 
      style={{ 
    ...
    >
        ...
        <AnimatePresence>
          {editing ? (
            ...
            >
              ...
              <Pencil className="absolute right-0 mr-2 text-base" />
            </motion.button>
          )}
        </AnimatePresence>
        <div
      ...
      <button className="flex w-full items-center justify-between rounded px-2 py-1.5 text-xs hover:bg-neutral-950/10 active:bg-neutral-50/15 dark:hover:bg-neutral-50/10">
        Transfer Project
        <ArrowUpDown className="text-base" />
      </button>
      <button className="flex w-full items-center justify-between rounded px-2 py-1.5 text-xs hover:bg-neutral-950/10 active:bg-neutral-50/15 dark:hover:bg-neutral-50/10">
        Project Settings
