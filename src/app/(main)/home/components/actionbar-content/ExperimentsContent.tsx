...
export function ExperimentsContent({ isActive }: MenuContentProps) {
  ...
  return (
    <div className="p-6 h-full flex">
      ...
      >
        <h4 className={`${secFont.className} font-medium mb-3 text-xl`}>Experiments</h4>
        <p className={`${triFont.className} text-sm leading-relaxed text-gray-600`}>
         ...
         <a href="/experiments" className={`${triFont.className} text-sm text-gray-600 hover:text-black mt-4 inline-block`}>
