      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.map((message) => (
          ...
          >
            ...
            >
              <p className={`${triFont.className} text-sm`}>{message.text}</p>
            </div>
            {message.sender === 'user' && (
        ...
        <form onSubmit={handleSubmit} className="flex items-center">
          <div className="flex-1 relative">
            <input
              ...
              className={`${triFont.className} text-sm text-gray-700 w-full p-3 pr-10 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-200`}
              value={inputValue}
          ...
          >
            <div className="flex items-center">
              <span className={`${triFont.className} text-sm mr-1`}>Send Message</span>
              <Send size={16} />
            </div>
          </button>
        </form>
