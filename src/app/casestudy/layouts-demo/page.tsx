...
export default function LayoutsDemo() {
  return (
    <div className="max-w-[800px] mx-auto px-[40px] py-[60px]">
      <h1 className={`${doto.className} text-[40px] font-bold mb-[40px] tracking-[-1px]`}>
        Case Study Layout Components
      </h1>
      
      <p className={`${louize.className} text-[18px] leading-[28px] mb-[40px]`}>
      ...
      {/* TEXT LAYOUTS */}
      <h2 className={`${doto.className} text-[28px] font-bold mb-[40px]`}>Text Layouts</h2>
      
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-TEXT-01: Full Width Text</h3>
      </div>
      ...
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-TEXT-02: Two Column Text</h3>
      </div>
      ...
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-TEXT-03: Three Column Text</h3>
      </div>
      ...
      {/* IMAGE LAYOUTS */}
      <h2 className={`${doto.className} text-[28px] font-bold mb-[40px] mt-[80px]`}>Image Layouts</h2>
      
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-IMG-01: Full Width Image</h3>
      </div>
      ...
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-IMG-02: Two Column Images</h3>
      </div>
      ...
      <h2 className={`${doto.className} text-[28px] font-bold mb-[40px] mt-[80px]`}>Mixed Content Layouts</h2>
      
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-MIXED-01: Image Left, Text Right</h3>
      </div>
      ...
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-MIXED-02: Text Left, Image Right</h3>
      </div>
      ...
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-MIXED-03: Image Top, Text Bottom</h3>
      </div>
      ...
      {/* SPECIAL LAYOUTS */}
      <h2 className={`${doto.className} text-[28px] font-bold mb-[40px] mt-[80px]`}>Special Layouts</h2>
      
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-SPECIAL-01: Highlight Box</h3>
      </div>
      ...
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-SPECIAL-02: Card Grid</h3>
      </div>
      ...
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-SPECIAL-03: Quote</h3>
      </div>
      ...
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-SPECIAL-04: Process Steps</h3>
      </div>
      ...
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-SPECIAL-05: Before/After Comparison</h3>
      </div>
      ...
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-SPECIAL-06: Single Column Report</h3>
      </div>
      ...
      <div className="inline-block bg-black text-white px-[12px] py-[8px] mb-[20px]">
        <h3 className={`${louize.className} text-[20px] font-medium`}>L-SPECIAL-07: Text with Image and Quote</h3>
      </div>
      ...
      <div className={`${louize.className} text-[16px] leading-[24px] mt-[120px] p-[24px] border border-[#e0e0e0] rounded-lg bg-[#f9f9f9]`}>
