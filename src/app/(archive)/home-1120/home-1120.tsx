...
import styles from '../../(main)/home/components/styles.module.css';
import UnifiedActionBar from '../../(main)/home/components/UnifiedActionBar';
                ...
                >
                  ...
                  >
                    <AnimatePresence>
                      {nameVisible && (
                        <div 
                          className={`${secFont.className} text-black text-[64px] font-bold leading-[60px] tracking-[-3.47px] mb-[44px]`}
                        >
                          <TextScramble
                            duration={1.0}
                            speed={0.04}
                        ...
                        <div className="flex items-center">
                          <AnimatePresence mode="wait">
                            ...
                            >
                              ...
                              />
                              <div className={`${secFont.className} w-[550px] text-white text-[21.7px] font-normal leading-[26.1px] tracking-[-0.65px]`}>
        ...
        <AnimatePresence>
          ...
          <motion.div
            ...
            >
              ...
              <AnimatePresence>
                {nameVisible && (
                  <div className={`${secFont.className} text-black text-[60px] font-bold leading-[60px] tracking-[-2px] mb-12`}>
                    <TextScramble
                      duration={1.0}
                      speed={0.04}
                      characterSet="ABCDEFGHIJKLMNOPQRSTUVWXYZ"
                  ...
                  <div className="flex items-center h-[60px]">
                    <AnimatePresence mode="wait">
                      ...
                      >
                        ...
                        />
                        <div className={`${secFont.className} text-[#191919] text-[18px] font-normal leading-[24px] tracking-[-0.5px]`}>
                          {carouselContent[currentPair].text}
                        </div>
                      </motion.div>
                    </AnimatePresence>
