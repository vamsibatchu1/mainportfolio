...
export default function Overview() {
  return (
    <div className="p-8 max-w-4xl mx-auto">
      {/* Section Header */}
      <div className="mb-12">
        <h2 className={`${priFont.className} text-4xl font-bold mb-4`}>Project Overview</h2>
        <div className={`${secFont.className} text-xl text-gray-600`}>
      ...
      <div className="grid grid-cols-3 gap-6 mb-12">
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <h3 className={`${priFont.className} text-lg font-bold mb-2`}>Timeline</h3>
          <p className={`${secFont.className}`}>8 weeks (Q3 2023)</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <h3 className={`${priFont.className} text-lg font-bold mb-2`}>My Role</h3>
          <p className={`${secFont.className}`}>UX/UI Designer, Research Lead</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <h3 className={`${priFont.className} text-lg font-bold mb-2`}>Key Metrics</h3>
          <p className={`${secFont.className}`}>+42% User Engagement</p>
        </div>
      </div>
      
      {/* Project Details */}
      <div className="mb-12">
        <h3 className={`${priFont.className} text-2xl font-bold mb-4`}>Project Background</h3>
        <div className={`${secFont.className} text-lg space-y-4`}>
          <p>
      ...
      <div className="grid grid-cols-2 gap-8">
        <div>
          <h3 className={`${priFont.className} text-2xl font-bold mb-4`}>Team Composition</h3>
          <ul className={`${secFont.className} text-lg space-y-2`}>
        ...
        <div>
          <h3 className={`${priFont.className} text-2xl font-bold mb-4`}>Tools Used</h3>
          <ul className={`${secFont.className} text-lg space-y-2`}>
