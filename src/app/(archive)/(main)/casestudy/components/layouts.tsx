...
export const FullWidthText = ({ content, className = "", sectionCode = "L-TEXT-01", id }: FullWidthTextProps) => {
  return (
    <section id={id} className={`mb-[80px] ${className}`} data-layout-code={sectionCode}>
      {content.heading && (
        <h2 className={`${secFont.className} text-[28px] font-normal mb-[20px] tracking-[-0.5px]`}>
          {content.heading}
        </h2>
      )}
      {content.subheading && (
        <h3 className={`${secFont.className} text-[22px] text-[#6f6f6f] mb-[16px] tracking-[-0.3px]`}>
          {content.subheading}
        </h3>
      )}
      <p className={`${secFont.className} text-[18px] leading-[28px] tracking-[-0.2px]`}>
        {content.paragraph}
      </p>
      {content.caption && (
        <p className={`${secFont.className} text-[14px] text-[#6f6f6f] mt-[12px] italic`}>
          {content.caption}
        </p>
      )}
    </section>
  ...
  return (
    <section id={id} className={`flex flex-wrap mb-[80px] gap-[40px] ${className}`} data-layout-code={sectionCode}>
      <div className={leftWidth}>
        {leftContent.heading && (
          <h2 className={`${secFont.className} text-[24px] font-normal mb-[16px] tracking-[-0.4px]`}>
            {leftContent.heading}
          </h2>
        )}
    ...
    <section id={id} className={`mb-[80px] ${className}`} data-layout-code={sectionCode}>
      <div className="grid grid-cols-3 gap-[40px]">
        {columns.map((column, index) => (
          <div key={index}>
            {column.heading && (
              <h3 className={`${secFont.className} text-[20px] font-normal mb-[12px] tracking-[-0.3px]`}>
                {column.heading}
              </h3>
            )}
            <p className={`${secFont.className} text-[16px] leading-[24px] tracking-[-0.2px]`}>
  ...
  return (
    <section id={id} className={`flex flex-wrap mb-[80px] gap-[40px] ${className}`} data-layout-code={sectionCode}>
      ...
      <div className={contentWidth}>
        ...
        {content.subheading && (
          <h3 className={`${secFont.className} text-[20px] text-[#6f6f6f] mb-[12px] tracking-[-0.3px]`}>
            {content.subheading}
          </h3>
        )}
        <p className={`${secFont.className} text-[16px] leading-[24px] tracking-[-0.2px]`}>
  ...
  return (
    <section id={id} className={`mb-[80px] ${className}`} data-layout-code={sectionCode}>
      <div className={`p-[32px] border-l-4 ${borderColor} ${backgroundColor} rounded-r-lg`}>
        {content.heading && (
          <h2 className={`${priFont.className} text-[22px] font-bold mb-[16px] tracking-[-0.3px]`}>
            {content.heading}
          </h2>
        )}
        <p className={`${secFont.className} text-[18px] leading-[28px] tracking-[-0.2px] ${content.heading ? "" : "italic"}`}>
          {content.paragraph}
        </p>
      </div>
    </section>
            ...
            <div className="flex items-start mb-[16px]">
              {showNumbers && (
                <div className="w-[32px] h-[32px] rounded-full bg-[#f3f3f3] flex items-center justify-center mr-[12px]">
                  <span className={`${priFont.className} text-black font-bold`}>{index + 1}</span>
                </div>
              )}
              {card.heading && (
                <h3 className={`${priFont.className} text-[18px] font-bold`}>{card.heading}</h3>
              )}
            </div>
            <p className={`${secFont.className} text-[16px] leading-[24px] tracking-[-0.2px]`}>
              {card.paragraph}
  ...
  return (
    <section id={id} className={`mb-[80px] ${className}`} data-layout-code={sectionCode}>
      <div className="py-[40px] border-t border-b border-[#e0e0e0]">
        <p className={`${secFont.className} text-[28px] leading-[36px] tracking-[-0.5px] italic mb-[24px]`}>
          &ldquo;{quote}&rdquo;
        </p>
        {author && (
          <div>
            <p className={`${priFont.className} text-[16px] font-bold`}>{author}</p>
            {role && <p className={`${secFont.className} text-[14px] text-[#6f6f6f]`}>{role}</p>}
          </div>
        )}
      </div>
    </section>
          ...
          <div key={index} className="flex mb-[40px] relative">
            <div className="mr-[24px]">
              <div className="w-[40px] h-[40px] rounded-full bg-black text-white flex items-center justify-center">
                <span className={`${priFont.className} font-bold`}>{index + 1}</span>
              </div>
            ...
            <div>
              <h3 className={`${priFont.className} text-[20px] font-bold mb-[8px]`}>{step.title}</h3>
              <p className={`${secFont.className} text-[16px] leading-[24px] tracking-[-0.2px]`}>
                {step.description}
              </p>
            </div>
...
export const BeforeAfter = ({ beforeImage, afterImage, caption, className = "", sectionCode = "L-SPECIAL-05", id }: BeforeAfterProps) => {
  return (
    <section id={id} className={`mb-[80px] ${className}`} data-layout-code={sectionCode}>
      <div className="flex gap-[24px]">
        <div className="w-1/2">
          <div className="mb-[8px] text-center">
            <span className={`${priFont.className} text-[16px] font-bold`}>Before</span>
          </div>
          <Image 
            src={beforeImage.src} 
        ...
        <div className="w-1/2">
          <div className="mb-[8px] text-center">
            <span className={`${priFont.className} text-[16px] font-bold`}>After</span>
          </div>
          <Image 
            src={afterImage.src} 
      ...
      {caption && (
        <p className={`${secFont.className} text-[14px] text-[#6f6f6f] mt-[12px] italic text-center`}>
          {caption}
        </p>
      )}
    </section>
  ...
  return (
    <section id={id} className={`mb-[80px] ${className}`} data-layout-code={sectionCode}>
      <div className="max-w-[720px]">
        {title && (
          <h2 className={`${priFont.className} text-[30px] font-bold mb-[30px] tracking-[-0.5px]`}>
            {title}
          </h2>
        )}
        
        {intro && (
          <p className={`${secFont.className} text-[18px] leading-[28px] tracking-[-0.2px] mb-[40px]`}>
            {intro}
          </p>
        )}
        ...
        <div className="space-y-[32px]">
          {sections.map((section, index) => {
            switch(section.type) {
              case 'heading':
                return (
                  <h3 key={index} className={`${secFont.className} text-[24px] font-medium tracking-[-0.4px]`}>
                    {section.content}
                  </h3>
                );
              case 'subheading':
                return (
                  <h4 key={index} className={`${secFont.className} text-[20px] font-medium tracking-[-0.3px] text-[#E05D2A]`}>
                    {section.content}
                  </h4>
                );
              case 'paragraph':
                return (
                  <p key={index} className={`${secFont.className} text-[18px] leading-[28px] tracking-[-0.2px]`}>
                    {section.content}
                  </p>
                );
              case 'quote':
                return (
                  <div key={index} className="pl-[24px] border-l-2 border-[#e0e0e0] py-[8px]">
                    <p className={`${secFont.className} text-[18px] leading-[28px] tracking-[-0.2px] italic mb-[8px]`}>
                      &ldquo;{section.content}&rdquo;
                    </p>
                    {section.author && (
                      <div>
                        <p className={`${secFont.className} text-[16px] font-medium`}>{section.author}</p>
                        {section.title && <p className={`${secFont.className} text-[14px] text-[#6f6f6f]`}>{section.title}</p>}
                      </div>
                    )}
                  </div>
                );
    ...
    <section id={id} className={`mb-[80px] ${className}`} data-layout-code={sectionCode}>
      ...
      <div className="flex justify-center">
        <div className="max-w-[700px] text-center">
          <p className={`${secFont.className} text-[28px] leading-[36px] tracking-[-0.5px] italic mb-[16px]`}>
            &ldquo;{quote}&rdquo;
          </p>
          {author && (
            <p className={`${secFont.className} text-[16px] text-[#6f6f6f]`}>
              {author}
            </p>
          )}
        </div>
