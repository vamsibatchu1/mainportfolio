...
export const PromptSection: React.FC<PromptSectionProps> = ({
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="box-border content-stretch flex flex-col gap-3 items-end justify-end p-0 relative w-full">
        {/* Prompt Suggestions */}
        <div className="relative shrink-0 w-full">
                    ...
                    <div className="box-border content-stretch flex flex-col h-8 items-start justify-center min-w-inherit p-[16px] relative">
                      <div className="relative shrink-0">
                        <div className="box-border content-stretch flex flex-col items-start justify-start p-0 relative">
                          <div className="flex flex-col font-['Plus_Jakarta_Sans:Medium',_sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#111111] text-[14px] text-left text-nowrap">
        ...
        <div className="bg-[#ffffff] h-[120px] relative rounded-[20px] shrink-0 w-full">
          <div className="relative size-full">
            <div className="box-border content-stretch flex flex-row items-start justify-between overflow-clip pl-6 pr-4 py-4 relative size-full">
              <div className="relative shrink-0 w-[305px]">
                <div className="box-border content-stretch flex flex-row justify-between p-0 relative w-[305px]">
                  <div className="font-['Plus_Jakarta_Sans:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[14px] text-left w-60">
                    <textarea
                      value={inputValue}
                      ...
                      className="block leading-[20px] w-full bg-transparent border-none outline-none resize-none font-['Plus_Jakarta_Sans:Medium',_sans-serif] font-medium text-[14px] text-[#000000] placeholder:text-[#9d9d9d] h-[88px]"
                      rows={1}
                    />
                  </div>
